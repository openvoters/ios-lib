...
static OVConfiguration *privateInstance;

@interface OVConfiguration ()
@end


@implementation OVConfiguration

+ (OVConfiguration *)sharedInstance {
  if (nil == privateInstance) {
    privateInstance = [[OVConfiguration alloc] init];
  }
