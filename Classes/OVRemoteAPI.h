...
@interface OVRemoteAPI : NSObject

+ (void) getList:(void (^)(NSArray *list))successBlock error:(void (^)(NSError *error))errorBlock;
+ (void) voteItem:(OVItem *)item uniqueID:(NSString *)uniqueID success:(void (^)())successBlock error:(void (^)(NSError *error))errorBlock;
